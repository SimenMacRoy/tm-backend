...
CREATE TABLE groups (
    ...
    name VARCHAR(255),
    date_creation DATE,
    admin_id INTEGER REFERENCES users(id) -- L'administrateur du groupe
);
...
CREATE TABLE tasks (
    ...
    status VARCHAR(50),
    group_id INTEGER REFERENCES groups(id),
    admin_id INTEGER REFERENCES users(id) -- L'administrateur de la tâche
);
...
INSERT INTO users (id, first_name, last_name, email, telephone, address, password, role) VALUES
...
INSERT INTO groups (id, name, date_creation, admin_id) VALUES
...
INSERT INTO tasks (id, name, description, due_date, status, group_id, admin_id) VALUES
